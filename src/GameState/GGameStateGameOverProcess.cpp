...
static ANIMSCRIPT GameOverAnimation[] = {
  ...
  ALABEL,
  ASTEP(30 + 10, IMG_GAME_OVER1),
  ASTEP(3 + 10, IMG_GAME_OVER1 + 1),
  ASTEP(15 + 10, IMG_GAME_OVER1),
  ASTEP(3 + 10, IMG_GAME_OVER1 + 1),
  ASTEP(8 + 10, IMG_GAME_OVER1 + 3),
  ASTEP(15 + 10, IMG_GAME_OVER1),
  ASTEP(3 + 10, IMG_GAME_OVER1 + 5),
  ASTEP(15 + 10, IMG_GAME_OVER1),
  ASTEP(3 + 10, IMG_GAME_OVER1 + 1),
  ASTEP(3 + 10, IMG_GAME_OVER1 + 2),
  ASTEP(8 + 10, IMG_GAME_OVER1),
  ASTEP(3 + 10, IMG_GAME_OVER1 + 1),
  ASTEP(3 + 10, IMG_GAME_OVER1 + 4),
  ALOOP
};
