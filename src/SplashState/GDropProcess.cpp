...
static ANIMSCRIPT Drop1Animation[] = {
  ABITMAP(PLAYER_SLOT),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP1),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP1+1),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP1+2),
  AEND
};

static ANIMSCRIPT Drop2Animation[] = {
  ABITMAP(PLAYER_SLOT),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP2),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP2+1),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP2+2),
  AEND
};

static ANIMSCRIPT Drop3Animation[] = {
  ABITMAP(PLAYER_SLOT),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP3),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP3+1),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP3+2),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP3+3),
  AEND
};

static ANIMSCRIPT Drop4Animation[] = {
  ABITMAP(PLAYER_SLOT),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP4),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP4+1),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP4+2),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP4+3),
  AEND
};

static ANIMSCRIPT Drop5Animation[] = {
  ABITMAP(PLAYER_SLOT),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP5),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP5+1),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP5+2),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP5+3),
  AEND
};

static ANIMSCRIPT Drop6Animation[] = {
  ABITMAP(PLAYER_SLOT),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP6),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP6+1),
  ASTEP(DROP_ANIM_SPEED, IMG_DROP6+2),
  AEND
};
